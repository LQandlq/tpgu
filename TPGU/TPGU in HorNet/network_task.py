...
@task_factory.register_task_cls(exp_cfg.TaskConfig)
class ExperimentTask(base_task.Task):
    """Class of an task.
    ...
    def build_model(self) -> tf.keras.Model:
        ...
        model = network_model.build_model(input_specs=input_specs, model_config=self.task_config.model,
                                         kernel_regularizer=l2_regularizer)
        return model

    def build_inputs(self, params: exp_cfg.DataConfig,
