...
import hornet_config as exp_cfg
import hornet_input
import hornet_model
...
class ExampleTask(base_task.Task):
    ...
    def build_model(self) -> tf.keras.Model:
        ...
        model = hornet_model.build_model(input_specs=input_specs, model_config=self.task_config.model,
    ...
    def build_inputs(self, params: exp_cfg.ExampleDataConfig,
        ...
        decoder = hornet_input.Decoder(image_field_key, label_field_key, is_multilabel)
        parser = hornet_input.Parser(output_size=input_size[:2], num_classes=num_classes,
